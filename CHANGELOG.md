...
`github.com/hashicorp/go-uuid v1.0.3`, `github.com/hashicorp/vault/api v1.8.2`, `github.com/hashicorp/vault/sdk v0.6.1`, `github.com/stretchr/testify v1.8.1`, 
`golang.org/x/oauth2 v0.1.0`, `google.golang.org/api v0.101.0` [[GH-143](https://github.com/hashicorp/vault-plugin-auth-gcp/pull/143)]
